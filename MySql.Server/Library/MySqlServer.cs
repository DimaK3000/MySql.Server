...
namespace MySql.Server {
	...
	public class MySqlServer {
		...
		public static MySqlServer GetInstance(string baseDirectory) {
			{
				if (instance == null) {
		...
		public void ExecuteNonQuery(string query) {
			MySqlHelper.ExecuteNonQuery(this.GetConnectionString(), query);
		}

		public MySqlDataReader ExecuteReader(string query) {
			return MySqlHelper.ExecuteReader(this.GetConnectionString(), query);
		}
